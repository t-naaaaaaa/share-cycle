...
<main class="page-main">
  ...
  <div class="page-pc-wrap">
    ...
    <div class="section-wrap">
      <section class="first">
        <h2 class="first-title">組織図</h2>
        <p class="first-text">
          <li class="only-member-li"><a class="only-member-a" href="<?php echo esc_url(get_template_directory_uri() . '/img/soshiki_2024_05.jpg'); ?>">2024年度組織図</a></li>
        </p>
    </div>
    </section>
  </div>
