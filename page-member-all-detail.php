    ...
    <div class="section-wrap member-all-section-wrap">
      ...
      <section class="second">
        ...
        <div class="member-all-wrap">
          ...
          <p href="" class="member-all-comp member-all-comp-left">IHI運搬機械株式会社</p>
          </p>
          <p>
            〒104-0044<br>
            東京都中央区赤石町８番1号<br>
          ...
          <div class="detail_title">事業内容</div>
          <p>
            パーキングシステム、運搬機械の企画・開発・設計・製造・販売・賃貸・据付・メンテナンス・改修・運営・管理事業
          </p>
          <div class="detail_bottom">
            <div class="detail_item">設備メーカー</div>
            <div class="detail_item">運営システムメーカー</div>
            <div class="detail_item">建設コンサルタント・開発・企画・デザイン・設計業者</div>
          </div>
        ...
        <div class="detail_bottom">
          <div class="detail_item">運営業者</div>
          <div class="detail_item">運営システムメーカー</div>
          <div class="detail_item">建設コンサルタント・開発・企画・デザイン・設計業者</div>
        </div>
        <p class="second-text text-2 member-all-comp-text">
        ...
        <div class="detail_bottom">
          <div class="detail_item">自転車メーカー</div>
          <div class="detail_item">運営業者</div>
          <div class="detail_item">設備メーカー</div>
          <div class="detail_item">運営システムメーカー</div>
          <div class="detail_item">関連設備商社、総合請負業者</div>
          <div class="detail_item">メンテナンス業者</div>
        </div>
        ...
        <div class="detail_bottom">
          <div class="detail_item">設備メーカー</div>
          <div class="detail_item">設備附属品メーカー</div>
        </div>
        <div class="member-all-wrap">
          <p class="second-text text-1">
        ...
        <div class="detail_bottom">
          <div class="detail_item">工事施工業者</div>
          <div class="detail_item">関連設備商社、総合請負業者</div>
          <div class="detail_item">その他</div>
        </div>
        <p class="second-text text-2 member-all-comp-text">
        ...
        <div class="detail_bottom">
          <div class="detail_item">運営業者</div>
          <div class="detail_item">関連設備商社、総合請負業者</div>
          <div class="detail_item">コールセンター</div>
          <div class="detail_item">その他</div>
        </div>
        <div class="member-all-wrap">
          <p class="second-text text-1">
      ...
      <section class="second second-end">
        ...
        <div class="member-all-wrap">
          ...
          <p>
            ...
            TEL:03-3663-6282<br>
            FAX:03-3667-9637<br>
            URL:<a href="http://www.jichuko.net/" target="_blank">http://www.jichuko.net/</a><br>
          </p>
        </div>
        <div class="detail_right">
          <div class="detail_title">事業内容</div>
