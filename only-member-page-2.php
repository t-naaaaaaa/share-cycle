...
<main class="page-main">
  <section class="page-title-wrap">
    <h1 class="page-title">2023年度事業方針、2023年度ロードマップ</h1>
  </section>
  ...
  <div class="page-pc-wrap">
    ...
    <div class="section-wrap">
      <section class="first">
        <h2 class="first-title">2023年度事業方針、2023年度ロードマップ</h2>
        <p class="first-text">
        <ul id="file">
          <li class="only-member-li"><a class="only-member-a" href="<?php echo esc_url(get_template_directory_uri() . '/member-pdf/houshin_2023.pdf'); ?>">2023年度事業方針</a></li>
          <li class="only-member-li"><a class="only-member-a" href="<?php echo esc_url(get_template_directory_uri() . '/member-pdf/roadmap_2023_01.pdf'); ?>">2023年度ロードマップ</a></li>
        </ul>
        </p>
    </div>
    </section>
