<?php
/*
Template Name: 役員、正会員、賛助会員、協力会員　名簿
*/
get_header();
?>
...
<main class="page-main">
  <section class="page-title-wrap">
    <h1 class="page-title">役員、正会員、賛助会員、協力会員　名簿</h1>
  </section>
  ...
  <div class="page-pc-wrap">
    ...
    <div class="section-wrap">
      <section class="first">
        <h2 class="first-title">役員、正会員、賛助会員、協力会員　名簿</h2>
        <p class="first-text">
          <li class="only-member-li"><a class="only-member-a" href="<?php echo esc_url(get_template_directory_uri() . '/member-pdf/member1_2023.pdf'); ?>">JSCA役員名簿</a></li>
          <li class="only-member-li"><a class="only-member-a" href="<?php echo esc_url(get_template_directory_uri() . '/member-pdf/member2_2023.pdf'); ?>">JSCA正会員名簿</a></li>
          <li class="only-member-li"><a class="only-member-a" href="<?php echo esc_url(get_template_directory_uri() . '/member-pdf/member3_2023.pdf'); ?>">JSCA賛助会員名簿</a></li>
          <li class="only-member-li"><a class="only-member-a" href="<?php echo esc_url(get_template_directory_uri() . '/member-pdf/member4_2023.pdf'); ?>">JSCA協力会員名簿</a></li>
        </p>
    </div>
    </section>
  </div>
